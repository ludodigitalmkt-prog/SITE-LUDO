      ...
      >
        <div className="max-w-4xl">
          ...
          <p className="mt-7 max-w-2xl text-lg leading-relaxed text-white/50">
            Experiências criadas com atmosfera, movimento e identidade
            visual próprios para cada tipo de celebração.
          </p>
        </div>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {categorias.map((categoria) => (
            <Link
              ...
              className="group relative isolate min-h-[540px] overflow-hidden rounded-[36px] border border-white/10 bg-[#101018] shadow-2xl transition duration-500 hover:-translate-y-2 hover:border-white/25"
            >
              <div
                className="absolute inset-0"
                style={{
                  background: `
                    radial-gradient(circle at 12% 10%, ${categoria.cor}85 0%, transparent 38%),
                    radial-gradient(circle at 90% 36%, ${categoria.corSecundaria}55 0%, transparent 34%),
                    linear-gradient(145deg, #15151f 0%, #06060b 68%)
                  `
                }}
              />

              <div
                className="absolute -left-20 top-24 h-72 w-72 rounded-full opacity-40 blur-[70px] transition duration-700 group-hover:translate-x-8 group-hover:scale-125"
                style={{ backgroundColor: categoria.cor }}
              />

              <div
                className="absolute -right-24 top-[-30px] h-72 w-72 rounded-full opacity-30 blur-[80px] transition duration-700 group-hover:-translate-x-6 group-hover:translate-y-8"
                style={{ backgroundColor: categoria.corSecundaria }}
              />

              <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,.035)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.035)_1px,transparent_1px)] bg-[size:52px_52px] opacity-35" />
              ...
              <div className="absolute left-7 right-7 top-7 z-20 flex items-center justify-between">
                ...
                <span className="grid h-12 w-12 place-items-center rounded-full border border-white/15 bg-black/25 text-xl backdrop-blur-xl transition duration-500 group-hover:rotate-45 group-hover:bg-white group-hover:text-black">
                  ↗
                </span>
              </div>

              <div className="absolute inset-x-0 bottom-0 z-10 h-[72%] bg-gradient-to-t from-black via-black/85 to-transparent" />
              ...
              <div className="absolute bottom-0 left-0 right-0 z-20 p-8">
                ...
                <h3 className="mt-5 text-[clamp(2.5rem,4vw,4rem)] font-black leading-[0.9] tracking-[-0.055em]">
                ...
                <div className="mt-7 flex items-center gap-3 text-sm font-black text-white/80">
